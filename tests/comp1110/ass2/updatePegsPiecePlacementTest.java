...
public class updatePegsPiecePlacementTest {
    ...
    public void testUnrotated()
    {
      ...
      int states[]=LinkGame.updatePegsPiecePlacement(PiecePlacement);
        ...
        assertTrue("there should be a ring with opening2 in the br2 but got "+Arrays.toString(states),states[12]==0&&states[15]==1&&states[16]==2&&states[17]==0);
    }
    @Test
    public void testrotating()
    {
        ...
        assertTrue("there should be a ring with opening1 in the br2 but got "+Arrays.toString(states),states[12]==0&&states[15]==1&&states[16]==1&&states[17]==0);
        String PiecePlacement1="MID";
        int states1[]=LinkGame.updatePegsPiecePlacement(PiecePlacement1);
        assertTrue("there should be a ball with connection34 in the origin but got "+Arrays.toString(states),states1[0]==1&&states1[1]==3&&states1[2]==4&&states1[3]==0);
        assertTrue("there should be a ball with connection6 in the br1 but got "+Arrays.toString(states),states1[6]==1&&states1[7]==6&&states1[8]==0&&states1[9]==0);
        assertTrue("there should be a ring with opening4 in the br2 but got "+Arrays.toString(states),states1[12]==0&&states1[15]==1&&states1[16]==4&&states1[17]==0);
    }
    @Test
